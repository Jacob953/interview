...
- [MySQL](#mysql)
  ...
  - [结果集做了一下 去重(distinct)](#结果集做了一下-去重distinct)
  - [建立索引的原则](#建立索引的原则)
  - [mysql的change buffer的作用？唯一索引，普通索引中用到？](#mysql的change-buffer的作用唯一索引普通索引中用到)
  - [查询很慢怎么排查和优化？](#查询很慢怎么排查和优化)
  - [EXPLAIN有什么用途？有哪些字段？](#explain有什么用途有哪些字段)
  - [InnoDB索引底层实现？为什么使用b+树不适用b树？](#innodb索引底层实现为什么使用b树不适用b树)
  - [为什么b+树减少了io](#为什么b树减少了io)
  - [什么是索引？什么是回表？](#什么是索引什么是回表)
  - [MySQL的ACID怎么实现？](#mysql的acid怎么实现)
  - [有哪些隔离级别？实现原理？](#有哪些隔离级别实现原理)
  - [脏读、幻读概念？怎么解决幻读的问题？间隙锁是什么？可重复读怎么实现？](#脏读幻读概念怎么解决幻读的问题间隙锁是什么可重复读怎么实现)
  - [MySQL怎么实现高可用？](#mysql怎么实现高可用)
  - [自增id到了最大，再insert一条数据会发生什么？](#自增id到了最大再insert一条数据会发生什么)
  - [从分组的结果中选出最大的5个数](#从分组的结果中选出最大的5个数)
  - [group和having的区别](#group和having的区别)
  - [live环境千万条数据如何迁移](#live环境千万条数据如何迁移)
  - [live环境数据备份](#live环境数据备份)
  - [live环境表格结构修改](#live环境表格结构修改)
  - [live环境批量数据修改](#live环境批量数据修改)
  - [live环境mysql主从同步 数据流失怎么办](#live环境mysql主从同步-数据流失怎么办)
  - [什么是mysql](#什么是mysql)
  - [什么是b+树](#什么是b树)
  - [2022-01-19收录](#2022-01-19收录)
